...
function kaktos_post_type_service()
{
...
add_action('init', 'kaktos_post_type_service');
...
function kaktos_post_type_company_cat()
{
...
add_action('init', 'kaktos_post_type_company_cat');
