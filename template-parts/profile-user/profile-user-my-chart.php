                                ...
                                <div class="col-sm-12 mt+ avatars">
                                    <div class="clearfix mb++">
                                        <div class="flip pull-left">
                                            <div class="relative avatar flip pull-right">
                                                <a href="">
                                                    <img class="img-circle profile-50" alt="clickstack" title="clickstack" src="./images/sidebar/img-02.jpg">
                                    ...
                                    <div class="clearfix mb++">
                                        <div class="flip pull-left">
                                            <div class="relative avatar flip pull-right">
                                                <a href="">
                                                    <img class="img-circle profile-50" alt="keivan88" title="keivan88" src="./images/sidebar/img-02.jpg">
                                    ...
                                    <div class="clearfix mb++">
                                        <div class="flip pull-left">
                                            <div class="relative avatar flip pull-right">
                                                <a href="">
                                                    <img class="img-circle profile-50" alt="alizamani16" title="alizamani16" src="./images/sidebar/img-02.jpg">
                                    ...
                                    <div class="clearfix mb++">
                                        <div class="flip pull-left">
                                            <div class="relative avatar flip pull-right">
                                                <a href="">
                                                    <img class="img-circle profile-50" alt="royallyhome" title="royallyhome" src="./images/sidebar/img-02.jpg">
                                    ...
                                    <div class="clearfix mb++">
                                        <div class="flip pull-left">
                                            <div class="relative avatar flip pull-right">
                                                <a href="">
                                                    <img class="img-circle profile-50" alt="alirezaet" title="alirezaet" src="./images/sidebar/img-02.jpg">
                                    ...
                                    <div class="clearfix mb++">
                                        <div class="flip pull-left">
                                            <div class="relative avatar flip pull-right">
                                                <a href="">
                                                    <img class="img-circle profile-50" alt="mohsenonline" title="mohsenonline" src="./images/sidebar/img-02.jpg">
                                ...
                                <div class="col-sm-12 mt+ avatars">
                                    <div class="clearfix mb++">
                                        <div class="flip pull-left">
                                            <div class="relative avatar flip pull-right">
                                                <a href="">
                                                    <img class="img-circle profile-50" alt="javadrahati" title="javadrahati" src="./images/sidebar/img-02.jpg">
                                    ...
                                    <div class="clearfix mb++">
                                        <div class="flip pull-left">
                                            <div class="relative avatar flip pull-right">
                                                <a href="">
                                                    <img class="img-circle profile-50" alt="mehdibeygipoor" title="mehdibeygipoor" src="./images/sidebar/img-02.jpg">
            ...
            <div class="row pv+++">
                <div class="col-md-8">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-6 mb+++">
                            <div class="row">
                                <div class="col-sm-12 fa-1-5em">کاربرانی که از پروفایل شما بازدید کردند
                                </div>
                                <div class="col-sm-12 mt+ avatars">
                                    <div class="clearfix mb++">
                                        <div class="flip pull-left">
                        ...
                        <div class="col-md-6">
                            <div class="row">
                                <div class="col-sm-12 fa-1-5em"> کاربرانی که شما از پروفایل آنها بازدید کردید
                                </div>
                                <div class="col-sm-12 mt+ avatars">
                                    <div class="clearfix mb++">
                                        <div class="flip pull-left">
                ...
                <div class="col-md-4 hidden-xs hidden-xxs hidden-sm">
                    <div class="row">
                        <div class="col-sm-12 fa-1-5em">
                            ...
                            <span>دریافت شده در شش ماه گذشته</span>
                        ...
                        <div class="col-sm-12 pb+">
                            <div class="list-group list-group-horizontal visible-table full-width min-h-80">
                                <a href="#" class="list-group-item width-xs-12 border-left border-color-10 visible-table-cell middle-v-a">
                                    ...
                                    <div class="flip pull-right btn-group p-btn-group" data-toggle="buttons">
                                        <label class="btn btn-alternative ph+++">ال
                                        </label>
                                    </div>
                        ...
                        <div class="col-sm-12 fa-1-5em pv++">
                            ...
                            <span>انجام شده در شش ماه گذشته</span>
                        </div>
                        <div class="col-sm-12 pb+">
                            <div class="list-group list-group-horizontal visible-table full-width min-h-80">
                                <a href="#" class="list-group-item width-xs-6 visible-table-cell middle-v-a">
        ...
        <div class="tab__content">
            <div class="row pv+++">
                ...
                <div class="col-md-4 hidden-xs hidden-xxs hidden-sm">
                    <div class="row">
                        <div class="col-sm-12 fa-1-5em">
                            <span>دریافت شده در سال گذشته</span>
                        </div>
                        <div class="col-sm-12 pv+">
                            <div class="list-group list-group-horizontal text-center visible-table full-width min-h-80">
                                <a href="#" class="list-group-item width-xs-4 visible-table-cell middle-v-a active">
                        ...
                        <div class="col-sm-12 fa-1-5em pv++">
                            ...
                            <span>انجام شده در سال گذشته</span>
                        </div>
                        <div class="col-sm-12 pb+">
                            <div class="list-group list-group-horizontal visible-table full-width min-h-80">
                                <a href="#" class="list-group-item width-xs-6 visible-table-cell middle-v-a">
            ...
            <div class="row pv+++">
                <div class="col-md-8">
                    ...
                    <div class="row mt-5">
                        <div class="col-md-6 mb+++">
                            <div class="row">
                                <div class="col-sm-12 fa-1-5em">کاربرانی که از پروفایل شمابازدید کردند
                                </div>
                                <div class="col-sm-12 mt+ avatars">
                                    <div class="clearfix mb++">
                                        <div class="flip pull-left">
